    ...
    <Container className="my-5">
      ...
      <div className="text-center mb-4">
        <ButtonGroup>
          ...
          <Button
            variant={filtro === "Bebida" ? "dark" : "outline-dark"}
            onClick={() => setSearchParams({ categoria: "Bebida" })}
          >
            Bebidas
          </Button>
          <Button
            variant={filtro === "Comida" ? "dark" : "outline-dark"}
            onClick={() => setSearchParams({ categoria: "Comida" })}
          >
            Comidas
          </Button>
        </ButtonGroup>
